...
export const IconFileDown = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M15 2v4h4" />
    <path d="M12.5 9.5v6" />
    <path d="m10 13.5 2.5 2.5 2.5-2.5" />
  </svg>
);
...
export const IconRefresh = (p: P) => (
  <svg {...base(p)}>
    <path d="M20 5v5h-5" />
    <path d="M20 10a8 8 0 1 0 .9 4" />
  </svg>
);

export const IconQuote = (p: P) => (
  <svg {...base(p)}>
    <path d="M10 7H6.5A2.5 2.5 0 0 0 4 9.5v1A2.5 2.5 0 0 0 6.5 13H8v1.5A2.5 2.5 0 0 1 5.5 17" />
    <path d="M20 7h-3.5A2.5 2.5 0 0 0 14 9.5v1a2.5 2.5 0 0 0 2.5 2.5H18v1.5a2.5 2.5 0 0 1-2.5 2.5" />
  </svg>
);
...
/** The zLibrary mark — a filled Z on a rounded ink tile. */
export const LogoMark = ({ size = 34 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
    <rect width="32" height="32" rx="7" fill="#f0a32f" />
    <path d="M8 8h16v4.4L13.8 20.6H24V24H8v-4.4L18.2 11.4H8z" fill="#0c1f31" />
  </svg>
);
